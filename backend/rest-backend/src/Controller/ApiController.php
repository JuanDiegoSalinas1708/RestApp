...
final class ApiController extends AbstractController
{
    ...
    public function crearProducto(Request $request, EntityManagerInterface $em): JsonResponse
    {
        ...
        $producto = new \App\Entity\Productos();
    ...
    public function eliminarProducto(int $id, EntityManagerInterface $em, ProductosRepository $productosRepository, InventarioRepository $inventarioRepository, DetalleOrdenRepository $detalleOrdenRepository): JsonResponse
    {
        $producto = $productosRepository->find($id);
        if (!$producto) {
            return $this->json([
        ...
        $inventarios = $inventarioRepository->findBy(['producto' => $producto]);
        foreach ($inventarios as $inventario) {
            $em->remove($inventario);
        }

        $detalles = $detalleOrdenRepository->findBy(['producto' => $producto]);
